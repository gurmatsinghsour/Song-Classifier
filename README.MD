...
A modern AI-powered web application for classifying song genres from lyrics using advanced machine learning techniques.

## Features

- **Genre Classification**: Identifies music genres (Rock, Country, R&B, Rap & Hip Hop) with 73%+ accuracy
- **Sentiment Analysis**: Analyzes emotional tone of lyrics (Positive, Negative, Neutral)
- **Content Detection**: Identifies explicit content in lyrics
- **Modern UI**: Clean, responsive web interface
- **RESTful API**: Easy integration with other applications

## Model Performance

- **Accuracy**: 73.9% on test dataset
- **Technology**: Hybrid approach combining sentence transformers and TF-IDF
- **Base Model**: DistilBERT (all-MiniLM-L6-v2) for semantic understanding
- **Features**: 684-dimensional feature space (384 embeddings + 300 TF-IDF)ric Genre & Content Classifier
